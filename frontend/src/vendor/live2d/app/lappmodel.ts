// @ts-nocheck -- vendored from Live2D Cubism SDK for Web Samples, lightly modified (2D_PLAN.md §3.2); not strict-checked by PAGI.
/**
 ...
 *
 * PAGI modifications (2D_PLAN.md §3.2, behavior-preserving only):
 *  - dropped the unused `LAppDelegate` import (PAGI doesn't vendor
 *    lappdelegate.ts — its only role there, CubismFramework startUp, is
